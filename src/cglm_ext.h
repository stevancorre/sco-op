...
#define GLMS_VEC3_PRINT(target) printf("vec3(%f, %f, %f)", target.x, target.y, target.x);
#define GLMS_VEC3_PRINTLN(target) printf("vec3(%f, %f, %f)\n", target.x, target.y, target.x);

#define GLMS_VEC4_PRINT(target) printf("vec4(%f, %f, %f, %f)", target.x, target.y, target.x, target.w);
#define GLMS_VEC4_PRINTLN(target) printf("vec4(%f, %f, %f, %f)\n", target.x, target.y, target.x, target.w);

#define GLMS_MAT4_PRINT(target) printf("mat4(%f, %f, %f, %f)", target.x, target.y, target.x, target.w);
